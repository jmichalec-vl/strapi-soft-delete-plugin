...
const canDeletePermanently = (policyContext: Record<string, unknown>) => {
  ...
  return state.userAbility.can(`plugin::${PLUGIN_ID}.explorer.delete-permanently`, params.uid);
};

export default canDeletePermanently;
