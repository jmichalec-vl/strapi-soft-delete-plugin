...
const canRestore = (policyContext: Record<string, unknown>) => {
  ...
  return state.userAbility.can(`plugin::${PLUGIN_ID}.explorer.restore`, params.uid);
};

export default canRestore;
